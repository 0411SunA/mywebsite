...
## Q3. total, asian 변수를 이용해 '전체 인구 대비 아시아 인구 백분율' 파생변수를 추가해 
...
## Q4. 아시아 인구 백분율 전체 평균을 구하고, 평균을 초과하면 'large',
## 그 외에는 'small'을 부여한 파생변수를 만들어 보세요.
```{python}
import numpy as np
...
midwest.head()
```
## Q5. 'large'와 'small'에 해당하는 지역이 얼마나 많은지 빈도표와 
